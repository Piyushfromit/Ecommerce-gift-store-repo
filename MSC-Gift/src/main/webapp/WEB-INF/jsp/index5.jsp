...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/jquery.formstyler.css">
    ...
    <link rel="stylesheet" href="/resources/css/jquery.mThumbnailScroller.css">
    ...
    <link rel="stylesheet" href="/resources/css/elements-media.css">
            ...
            <ul class="links_list links_list-align-right align-center-desktop topbar-contacts">
                ...
                <li>
                    ...
                    <p class="links_list-value">
                        ...
                        <a href="http://maps.google.com/" target="_blank" rel="nofollow">Patna Bihar India</a>
                ...
                <li>
                    ...
                    <p class="links_list-value">
                        ...
                        <a href="piyush@mscgift.com">piyush@mscgift.com</a>
                ...
                <li>
                    ...
                    <p class="links_list-value">
                        ...
                        <a href="tel:+91-7903191158">+91-7903191158</a>
...
<div class="heroblock" style="background-image: url(img/1/front/hero1.jpg);">
...
<div class="container mb60 page-styling row-wrap-container row-wrap-nottl">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/2.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/3.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/4.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/5.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/6.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/7.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/8.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
    ...
    <div class="sectgl prod-i">
        <div class="prod-i-top">
            <a class="prod-i-img" href="product.html">
                <img src="img/1/products/9.jpg" alt="">
            </a>
            <div class="prod-i-actions">
                <div class="prod-i-actions-in">
                    <div class="prod-li-favorites">
...
<!-- Mirrored from real-web.pro/html/multishop/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Nov 2023 13:14:35 GMT -->
</html>